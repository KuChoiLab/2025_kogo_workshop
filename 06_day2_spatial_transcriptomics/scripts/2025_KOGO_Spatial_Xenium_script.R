...
# saveRDS(xenium.obj, file = 'data/xenium/xenium_obj.rds')
xenium.obj <- readRDS('data/xenium/xenium_obj.rds')
...
# saveRDS(xenium.obj, file = 'data/xenium/xenium_preprocessed.rds')

# Load preprocessed data
xenium.obj <- readRDS('data/xenium/xenium_preprocessed.rds')
